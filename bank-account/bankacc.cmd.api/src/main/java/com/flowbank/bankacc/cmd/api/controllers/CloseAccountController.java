...
import com.flowbank.bankacc.cmd.api.commands.CloseAccountCommand;
...
public class CloseAccountController {
    ...
    public ResponseEntity<BaseResponse> closeAccount(@PathVariable(value = "id") String id) {
        try {
            ...
            var safeMessage = "Error while processing request to close bank account for id - " + id;
            log.error("IN closeAccount. {} ", safeMessage);
