package com.flowbank.bankacc.query.api.controllers;
...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccounts() {
        try {
            ...
            log.error("IN getAllAccounts. {}", safeMessage);
    ...
    public ResponseEntity<AccountLookupResponse> getAccountById(@PathVariable(value = "id") String id) {
        try {
            ...
            var safeMessage = "Failed to complete get account by ID request";
            log.error("IN getAccountById. {}", safeMessage);
    ...
    public ResponseEntity<AccountLookupResponse> getAccountByHolderId(@PathVariable(value = "accountHolderId") String accountHolderId) {
        try {
            ...
            var safeMessage = "Failed to complete get account by holder ID request";
            log.error("IN getAccountByHolderId. {}", e.getMessage());
    ...
    public ResponseEntity<AccountLookupResponse> getAccountByHolderId(@PathVariable(value = "equalityType") EqualityType equalityType,
        ...
        try {
            ...
            var safeMessage = "Failed to complete get accounts with balance request";
            log.error("IN getAccountByHolderId. {}", safeMessage);
